...
The `shadcn-ng` CLI will automatically generate this file for you when you run the `build` command.
...
Add your first component. Here's an example of a simple `<hello-world />` component:

```angular-ts title="registry/new-york/hello-world/hello-world.tsx showLineNumbers
  ...
  "items": [
    {
      ...
      "files": [
        {
          "path": "registry/new-york/hello-world/hello-world.ts",
...
```bash
npx shadcn-ng@latest add http://localhost:3000/r/hello-world.json
```
