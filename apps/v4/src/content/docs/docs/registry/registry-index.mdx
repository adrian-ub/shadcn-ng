...
You can see the full list at [https://ui.adrianub.dev/r/registries.json](https://ui.adrianub.dev/r/registries.json).

## Adding a Registry

You can submit a PR to add a registry to the index by adding it to the [registries.json](https://github.com/adrian-ub/shadcn-ng/blob/main/apps/v4/public/r/registries.json) file.
