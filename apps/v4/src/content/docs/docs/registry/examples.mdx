...
### Custom style that extends shadcn/ng

The following registry item is a custom style that extends shadcn/ui. On `npx shadcn-ng init`, it will:

- Install `@ngxi/tabler` as a dependency.
...
The following registry item is a custom style that doesn't extend shadcn/ng. See the `extends: none` field.

It can be used to create a new style from scratch i.e custom components, css vars, dependencies, etc.

On `npx shadcn-ng add`, the following will:
...
```json title="login-01.json" showLineNumbers
{
  ...
  "files": [
    {
      "path": "blocks/login-01/page.ts",
      "content": "import { LoginForm } ...",
      "type": "registry:page",
      "target": "app/login/page.ts"
    },
    {
      "path": "blocks/login-01/components/login-form.ts",
      "content": "...",
...
You can install a block fromt the shadcn/ng registry and override the primitives using your custom ones.

On `npx shadcn-ng add`, the following will:

- Add the `login-01` block from the shadcn/ng registry.
