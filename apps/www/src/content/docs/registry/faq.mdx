...
Here's an example of a complex component that installs a page, two components, a service, a format-date utils and a config file.
...
```json showLineNumbers
{
  ...
  "files": [
    ...
    {
      "path": "registry/hello-world/components/hello-world.ts",
      "type": "registry:component"
    },
    {
      "path": "registry/hello-world/components/formatted-message.ts",
      "type": "registry:component"
    },
    {
      "path": "registry/hello-world/services/hello.service.ts",
