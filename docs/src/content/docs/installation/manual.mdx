...
If you're using the `default` style, install `@ng-icons/lucide`:

```bash
npm install @ng-icons/lucide
```

If you're using the `new-york` style, install `@ng-icons/radix-icons`:

```bash
npm install @ng-icons/radix-icons
```
