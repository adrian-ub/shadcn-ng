import type { rawConfigSchema } from '@/src/registry/schema'
...
const TS_CONFIG_SCHEMA = z.object({
  compilerOptions: z.object({
    paths: z.record(z.string(), z.union([z.string(), z.array(z.string())])),
  }),
})
...
export async function getProjectInfo(cwd: string): Promise<ProjectInfo | null> {
  ...
  // Angular.
  if (configFiles.find(file => file.startsWith('angular.'))?.length) {
