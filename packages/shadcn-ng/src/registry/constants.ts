...
export const REGISTRY_URL
  = process.env.REGISTRY_URL ?? 'https://ui.adrianub.dev/r'
...
export const BUILTIN_REGISTRIES: z.infer<typeof registryConfigSchema> = {
  '@shadcn-ng': `${REGISTRY_URL}/styles/{style}/{name}.json`,
}
...
export const DEPRECATED_COMPONENTS: { name: string, deprecatedBy: string, message: string }[] = []
