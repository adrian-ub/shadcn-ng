        ...
        inputSchema: z.toJSONSchema(
          z.object({
            registries: z
              .array(z.string())
              .describe(
                'Array of registry names to search (e.g., [\'@shadcn-ng\', \'@acme\'])',
              ),
            limit: z
              .number()
              .optional()
        ...
        inputSchema: z.toJSONSchema(
          z.object({
            items: z
              .array(z.string())
              .describe(
                'Array of item names with registry prefix (e.g., [\'@shadcn-ng/button\', \'@shadcn-ng/card\'])',
              ),
          }),
        ),
      },
        ...
        inputSchema: z.toJSONSchema(
          z.object({
            items: z
              .array(z.string())
              .describe(
                'Array of items to get the add command for prefixed with the registry name (e.g., [\'@shadcn-ng/button\', \'@shadcn-ng/card\'])',
              ),
          }),
        ),
      },
