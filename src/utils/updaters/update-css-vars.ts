...
function updateThemePlugin(cssVars: z.infer<typeof registryItemCssVarsSchema>): postcss.Plugin {
  return {
...
function addCustomVariant({ params }: { params: string }): postcss.Plugin {
  return {
...
function addCustomImport({ params }: { params: string }): postcss.Plugin {
  return {
