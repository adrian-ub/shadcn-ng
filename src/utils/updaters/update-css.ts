...
function updateCssPlugin(css: z.infer<typeof registryItemCssSchema>): postcss.Plugin {
  return {
...
function processRule(parent: Root | AtRule, selector: string, properties: any): void {
